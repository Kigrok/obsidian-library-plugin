...
export const I18N: Record<SupportedLocale, Record<string, string>> = {
	en: {
		...
		'settings.field.type': 'Type value',
		'settings.field.source': 'Source',
	...
	ru: {
		...
		'settings.field.type': 'Значение Type',
		'settings.field.source': 'Источник',
	...
	de: {
		...
		'settings.field.name': 'Name',
		'settings.field.type': 'Type-Wert',
		'settings.field.source': 'Quelle',
	...
	es: {
		...
		'settings.field.type': 'Valor de Type',
		'settings.field.source': 'Fuente',
	...
	fr: {
		...
		'settings.field.type': 'Valeur Type',
		'settings.field.source': 'Source',
